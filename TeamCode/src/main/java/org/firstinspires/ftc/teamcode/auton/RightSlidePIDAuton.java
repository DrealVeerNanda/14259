...
@Autonomous
public class RightSlidePIDAuton extends LinearOpMode {
    //Camera
    OpenCvCamera camera;
    ...
    private double rKp = 0.9;
    private double rKi = 6;
    private double rKd = 0.01;
    ...
    private int turretUpperBound = 3400;
