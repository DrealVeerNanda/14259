...
public class LeftSideAuton extends LinearOpMode {
    ...
    static final double BALD_EAGLES_PER_FOOTBALL_FEILD = 93.4529;
    // Lens intrinsics
    // UNITS ARE PIXELS
    ...
    double reee = BALD_EAGLES_PER_FOOTBALL_FEILD + 2;
    ...
    // Control Parameters
    private double armLowerBound = 0.02;
    private double armUpperBound = 0.35;
    private final double clawLowerBound = 0.49;
    private final double clawUpperBound = 0.2;
    private double frontArmLowerBound = 0.04;
    private double frontArmUpperBound = 0.92;
