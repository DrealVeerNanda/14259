...
//
//@Autonomous
//public class LeftSidePIDAuton extends LinearOpMode {
//    //Camera
//    OpenCvCamera camera;
...
//    private double xKd = 0.008;
//    private double yKp = 0.06; // 0.06; // 0.046;
//    private double yKi = 0.5; // 0.05; // 1.17;
//    private double yKd = 0.008; // 0.005; // 0.006;
//    private double rKp = 1.065;
//    private double rKi = 0.6;
...
//    private int turretUpperBound = 5600;
...
//    private double[] linSlidePositions = { 0.0, 0.7, 0.96 };
...
//            updateAll();
//            this.driveWrapper.setPose(0, 50, -Math.PI / 2);
//            for(int i = 0; i < 25; i++) this.updateAll();
//            this.driveWrapper.setPose(0, 50, -Math.PI / 2);
//            for(int i = 0; i < 22; i++) this.updateAll();
////            parked = true;
//            this.displayStats();
//            armPosition = 7;
//            linSlidePosition = 2;
...
//                dump();
////                parked = true;
////                for(int j = 0; j < 7; j++) this.updateAll();
////                parked = false;
//                sleep(400);
//            }
//            dump();
...
//        if(i == 5) frontArm.setPosition(frontArmPositions[frontArmPosition] + 0.15);
