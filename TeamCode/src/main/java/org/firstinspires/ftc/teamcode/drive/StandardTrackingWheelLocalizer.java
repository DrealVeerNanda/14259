...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.60225; // in; distance between the left and right wheels
    ...
    public static double Y_MULTIPLIER = 0.945; // Multiplier in the Y direction
